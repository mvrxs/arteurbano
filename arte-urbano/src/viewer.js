import './style.css'; // o './viewer.css' si lo separas
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    async function main() {
        ...
        if (!item) {
            app.innerHTML = `<div style="color:#fff;padding:16px;font:14px system-ui">
        Modelo no encontrado para <b>${slug}</b>
      </div>`;
            return;
        }
